...
CLASSIFIERS_CONFIG_FILE_NAME_STUMP="exp_Bagging_Classifiers_{}.json"

METHOD_NAMES=["BCs1", "BCs2", "BC", "MV", "MA", "TB"]
...
def generate_configs(comm_sizes, n_base_classifiers,n_methods):
    ...
    n_methods.value = classifier_creator.nMethods()
    ...
    for comm_size in comm_sizes:
        ...
        classifier_creator.createClassifiersConfigBagging(classifier_config_file_path,comm_size)
        ...
        while(True):
            try:
                ...
                if config is None:
                    ...
                    self.logger.debug("PID {} Fit and predict".format( mp.current_process().pid))
...
class LoggerProcess(mp.Process):
    ...
    def run(self) -> None:
        ...
        log_file = os.path.join(self.output_dir,"Experiment_Bagging_{}.log".format(date_string))
...
if __name__ == '__main__':
    ...
    res_dir = os.path.join( settings.RESULSTPATH, "bagging" )
